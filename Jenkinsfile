    ...
    stage('Sonarqube scan code') {
     ...
     stage('Depoy to Staging') {
      steps {
       ...
       ansiblePlaybook credentialsId: 'deepan-ssh-access-key', installation: 'ansible', inventory: '/tmp/ansible-playbooks/inv.ini', playbook: '/tmp/ansible-playbooks/install_sensu_client.yml'
